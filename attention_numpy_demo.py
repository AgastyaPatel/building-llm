"""
Demo of attention in numpy
We use T=3 tokens, and d_model = 4, d_k=d_v=2m single_head
This script prints immediate tensors so you can trace the math.
